   ...
   return (
      <div className="App">
        ...
        <section className="App__buttons">
          <button data-amount={10000} onClick={this.dispachBtnAction}>WITHDRAW $10,000</button>
          <button data-amount={5000} onClick={this.dispachBtnAction}>WITHDRAW $5,000</button>
        </section>
